...
const SoulIcon = () => (
  <svg width="20" height="20" viewBox="0 0 32 32" fill="none" aria-hidden>
    <circle cx="16" cy="16" r="13" fill="none" stroke="rgba(74,158,255,0.45)" strokeWidth="1.2" />
    <ellipse cx="16" cy="16" rx="4" ry="6" fill="none" stroke="rgba(74,158,255,0.6)" strokeWidth="1.2" />
    <circle cx="16" cy="16" r="2" fill="rgba(74,158,255,0.8)" />
  </svg>
)
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex flex-col items-center gap-6 text-center">
        ...
        <p style={{ fontSize: '0.75rem', color: 'rgba(122,138,170,0.5)', lineHeight: 1.6, maxWidth: 540 }}>
